...
import type { BudgetData, ExploreSpot, Itinerary, RiskData, TripData } from "./services/groq.ts";
import { generateExploreSpots, generateItineraries, generateRiskPlanning } from "./services/groq.ts";
...
function App() {
    ...
    const handleGenerateItinerary = async () => {
        ...
        try {
            ...
            const calculatedTripLength = Math.max(
                1,
                ...
                <svg viewBox="0 0 60 1000" preserveAspectRatio="none">
                    ...
                    <g id="spine-dots">
                        {["hero", "route", "budget", "safety", "about", "contact"].map(id => {
                            ...
                            const y = section
                                ? (section.offsetTop / (document.body.scrollHeight - window.innerHeight)) * 1000
                                : 0;
                            return (
                                <g
                                    key={id}
