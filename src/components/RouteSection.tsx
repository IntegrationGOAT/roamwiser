import type { Itinerary } from '../services/openrouter.ts'
      ...
      <div className="days">
        {isGenerating ? (
                    ...
                    {itin.days.map((day, idx) => (
                      <div key={idx} className="schedule-day">
                        ...
                        <div className="schedule-content">
                          <div className="schedule-item"><strong>Morning:</strong> {day.morning}</div>
                          <div className="schedule-item"><strong>Afternoon:</strong> {day.afternoon}</div>
                          <div className="schedule-item"><strong>Evening:</strong> {day.evening}</div>
                        </div>
                      </div>
                    ))}
                  </div>
          ...
          <div className="empty-state">
            ...
            <p className="empty-state-text">Fill in your trip details and click "Generate my itinerary" to see your personalized travel plans</p>
          </div>
        )}
      </div>
    </section>
