    ...
    return (
        <section id="hero" data-spine="Plan">
            ...
            <svg className="contours" viewBox="0 0 1200 800" preserveAspectRatio="none">
                <path
                    d="M-50,600 Q300,500 600,600 T1250,550"
                    stroke="#5BCBB3"
                    strokeWidth="1"
                    fill="none"
                    opacity=".3"
                />
                <path
                    d="M-50,650 Q300,560 600,660 T1250,610"
                    stroke="#5BCBB3"
                    strokeWidth="1"
                    fill="none"
                    opacity=".22"
                />
                <path
                    d="M-50,700 Q300,620 600,710 T1250,670"
                    stroke="#5BCBB3"
                    strokeWidth="1"
                    fill="none"
                    opacity=".15"
            ...
            <div className="hero-grid">
                <div>
                    <div className="eyebrow hero-eyebrow">
                        itinerary planning · budget optimiser · live safety alerts
                    </div>
                    <h1 className="display">
                        Plan the trip.
                        <br />
                        Skip the <em>guesswork</em>.
                    </h1>
                    <p className="hero-sub">
                        Tell Roamwise your budget, your people, your days and what you're into. We build the day-by-day
                        route, optimise the spend, and watch the road ahead for weather and safety so you don't have to.
                    </p>
                ...
                <div className="ticket" id="plan">
                    ...
                    <div className="field">
                        ...
                        <div className="custom-interest-input">
                            ...
                            />
                            <button type="button" onClick={onAddCustomInterest}>
                                Add
                            </button>
                        </div>
                    </div>
                    ...
                    <button className="btn btn-gold ticket-cta" onClick={onGenerateItinerary} disabled={isGenerating}>
