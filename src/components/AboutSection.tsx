    ...
    <section id="about" className="light" data-spine="About">
      <div className="about-wrap">
        <div>
          ...
          <p className="muted">We're a small team based between Kolkata, working directly with local guides, homestays and tourism boards so every recommendation is one we'd actually send a friend to.</p>
        </div>
